...
def main():
    ...
    # Sanity check to make sure the threads were set up properly.
    # for phil in phils:
    #     print("Phil # %d", phil.phil_id)
    #     print("Left lock ", id(phil.left_stick))
    #     print("Right lock ", id(phil.right_stick))
    #     print("\n")
